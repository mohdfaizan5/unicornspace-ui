...
const testimonials: TestimonialProps[] = [
  [
    {
      content:
      // tell how it addes value to the user
        "It is a great tool that helps me to save time and focus on the core functionality of my project. It is a great tool that helps me to save time and focus on the core functionality of my project.",
      author: {
        name: "Mohammed Tahir",
        role: "Developer",
  ...
  [
    ...
    {
      content:
        "Its a thing I use on my daily basic.",
      author: {
        name: "Akshy",
        role: "Student",
