...
function Plan({ name, price, description, href, features, featured = false }) {
  return (
    <section
      className={clsx(
        "flex flex-col rounded-3xl px-6 sm:px-8 border py-5",
        featured ? "order-first bg-primary py-8 lg:order-none" : "lg:py-8"
      )}
    >
      <h3
        className={cn(
          "mt-5 font-display text-lg text-foreground",
...
export function Pricing2() {
  return (
    <section
      id="pricing"
      aria-label="Pricing"
      className="text-foreground py-20 sm:py-32"
    >
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="md:text-center">
          <h2 className="font-display text-3xl tracking-tight sm:text-4xl">
            <span className="relative whitespace-nowrap">
              <SwirlyDoodle className="absolute top-1/2 left-0 h-[1em] w-full fill-primary/60" />
