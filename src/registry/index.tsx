...
async function initializeRegistry() {
  componentRegistry['faq'] = {
    component: Faq,
    code: await readFileContent('Faq.tsx'),
  };
...
//     const componentsDir = path.join(process.cwd(), 'src', 'registry', "components", "Faq", "faq1.tsx");
//     // const filePath = './path/to/your/file.txt'; // Replace with your file path
//     const fileContent = await fs.readFile(componentsDir, 'utf-8');
