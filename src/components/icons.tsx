...
export const Icons = {
  nextjs: ({ className }: IconProps) => (
    <svg
      className={cn("size-8 dark:bg-white dark:px-1", className)}
  ...
  TailwindCSS: ({ className }: IconProps) => (
    <svg
      role="img"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
  ...
  framerMotion: ({ className }: IconProps) => (
    <svg
      role="img"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
