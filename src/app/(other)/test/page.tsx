...
const features = [
  ...
  {
    name: "Build beautiful interfaces",
    description:
      "Craft visually stunning and functional websites with pre-designed layouts and components.",
    icon: DeviceCardsIcon,
  },
  {
    name: "Streamline your workflow",
    description:
      "Reduce the time spent on repetitive tasks with integrated tools and reusable components.",
    icon: DeviceClockIcon,
  },
  {
    name: "Stay focused on core tasks",
    description:
      "Leave the UI and boilerplate code to us, so you can focus on solving real problems.",
    icon: DeviceListIcon,
  },
  {
    name: "Learn and grow",
    description:
      "Access resources on design principles, typography, and UI/UX best practices to enhance your skills.",
    icon: DeviceLockIcon,
  },
  {
    name: "Track project progress",
    description:
      "Use our comprehensive suite of tools to monitor and optimize every phase of your web development projects.",
...
function DeviceCardsIcon(props: Props) {
  ...
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      ...
      />
      <rect x={9} y={6} width={14} height={4} rx={1} fill="#FE9567" />
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <defs>
        <linearGradient
          id={`${id}-gradient`}
  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        ...
        fill="#737373"
      />
      <circle cx={11} cy={14} r={2} fill="#FE9567" />
      <circle cx={11} cy={20} r={2} fill="#FE9567" />
      <circle cx={11} cy={26} r={2} fill="#FE9567" />
      <path
