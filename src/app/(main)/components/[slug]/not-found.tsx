...
const NotFound = () => {
    ...
    return (
        <div>    <div className="container mx-auto flex min-h-[calc(90vh-8rem)] md:w-[80%] items-center px-6 py-12">
            <div className="mx-auto flex max-w-sm flex-col items-center text-center">
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                    The component you are looking for doesn&apos;t exist.
                </p>
