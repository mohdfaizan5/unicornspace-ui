...
title: Pricing
isPublished: true
description: The pricing section is ideal for helping users compare options and make confident decisions.
image: 	/images/pricing.png
priority: 2
---

## Purpose
The pricing section should be well-structured, featuring tiered plans with clear headings, concise descriptions, and actionable buttons. Ideal for helping users compare options and make confident decisions.
